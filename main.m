...
tblMDA = readtable('MDACCtrain_ICI_Chemo.xlsx');
dataMDA = removevars(tblMDA,{'patient_id','Single_Combine','Line_of_IO_conden'});
...
tblMDAExt = readtable('MDACCVal_ICI_Chemo.xlsx');
dataMDAExt = removevars(tblMDAExt,{'patient_id','Single_Combine','Line_of_IO_conden'});
...
tblMayo = readtable('MayoVal_ICI_Chemo.xlsx');
dataMayo = removevars(tblMayo,{'patient_id','Single_Combine','Line_of_IO_conden',});
...
% plot bar plot of feature importance ranking
...
%     ScoreCVmdlSVM = fitSVMPosterior(CVmdlSVM);
%     ScoremdlSVM = fitSVMPosterior(mdlSVM);
